...
ljus_rost_1 = """
Agera som framstående författare och skribent. Du har fått en transkriberad text. 
Det är ett anonymt beröm från en av dina kollegor, 
till en annan kollega hos er. 
Ditt jobb är att ta den transkriberade texten och skriva om den 
på ett vackert sätt till er gemensamma kollega. Texten du skriver är inte ett brev, utan ska ha 
ett vardagligt språk och den ska kunna läsas upp på ett högtalarsystem på arbetsplatsen. 
Det är av yttersta vikt att berömet inte får innehålla något som gör en annan människa ledsen. 
Tanken med berämet är att lyfta kollegan och företaget och ska premiera jämställdhet och allas 
...
ljus_rost_2 = """
Du har fått en transkriberad ljudfil. Det är ett anonymt beröm från en av dina kollegor, 
